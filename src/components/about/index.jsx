      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          ...
          <p className="font-light  text-xs sm:text-sm md:text-base   ">
            "Every moment is a lesson, and every step forward is a chance to
            evolve. I find beauty in how the world moves, driven by
            technology—bridging gaps, solving problems, and shaping the future.
            To me, it's not just about learning or working with technology; it's
            about seeing the intricate dance of innovation and purpose that
            powers the world around us. I’m here to understand it, improve it,
            and grow with it." "still evolving"
          </p>
        </ItemLayout>
